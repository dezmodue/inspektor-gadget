...
type GadgetRunRequest struct {
	...
	// token passed via gadgetctl --token (sensitive; do not log).
...
func (x *GadgetRunRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
const file_api_api_proto_rawDesc = "" +
	"\n" +
	"\rapi/api.proto\x12\x03api\"\xb4\x02\n" +
	...
	"\atimeout\x18\r \x01(\x03R\atimeout\x12\x14\n" +
	"\x05token\x18\x0e \x01(\tR\x05token\x1a>\n" +
